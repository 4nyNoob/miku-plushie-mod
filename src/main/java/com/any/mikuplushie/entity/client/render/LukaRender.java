...
public class LukaRender extends GeoEntityRenderer<LukaEntity> {
    ...
    @Override
    public void preRender(MatrixStack poseStack, LukaEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
