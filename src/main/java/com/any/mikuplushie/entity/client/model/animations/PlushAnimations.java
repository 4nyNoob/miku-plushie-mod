...
//    public static void limbAnimations(RenderPassInfo<R> renderPassInfo, BoneSnapshots snapshots){
        //LIMB ANIM VARIABLES

//        renderPassInfo.getGeckolibData(AbstractPlushModel.LIMB_SWING);
//
...
//    public static void hairMovement(RenderPassInfo<R> renderPassInfo, BoneSnapshots snapshots){
        //ANIM VARIABLES
//        float limbSwing = state.getLimbSwing();
//        float swingAmm = state.getLimbSwingAmount();
//        float toRad = (float) (Math.PI / 180);
