...
public class AikoRender extends GeoEntityRenderer<AikoEntity> {
    ...
    @Override
    public void preRender(MatrixStack poseStack, AikoEntity animatable, BakedGeoModel model, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
