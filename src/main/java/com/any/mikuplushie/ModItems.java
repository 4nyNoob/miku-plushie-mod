...
public class ModItems {
	...
	public static final Item TETO_PICKAXE =
        register(new PickaxeItem(PlushToolMaterial.PLUSH_TOOL_MATERIAL, 1, -2.8f, new FabricItemSettings()), "teto_pickaxe");
	...
	public static final Item TETO_PICKAXE_MESMERIZER =
        register(new PickaxeItem(PlushToolMaterial.PLUSH_TOOL_MATERIAL, 1, -2.8f, new FabricItemSettings()), "teto_pickaxe_mesmerizer");
	...
	public static final Item TETO_PICKAXE_BIRDBRAIN =
        register(new PickaxeItem(PlushToolMaterial.PLUSH_TOOL_MATERIAL, 1, -2.8f, new FabricItemSettings()), "teto_pickaxe_birdbrain");
	...
	public static final Item TETO_PICKAXE_REGRET_ROCK =
        register(new PickaxeItem(PlushToolMaterial.PLUSH_TOOL_MATERIAL, 1, -2.8f, new FabricItemSettings()), "teto_pickaxe_regret_rock");
	...
	public static final Item TETO_PICKAXE_DONT_BELIEVE_IN_T =
        register(new PickaxeItem(PlushToolMaterial.PLUSH_TOOL_MATERIAL, 1, -2.8f, new FabricItemSettings()), "teto_pickaxe_dont_believe_in_t");
	...
	public static final Item TETO_PICKAXE_LIAR_DANCER =
        register(new PickaxeItem(PlushToolMaterial.PLUSH_TOOL_MATERIAL, 1, -2.8f, new FabricItemSettings()), "teto_pickaxe_liar_dancer");
	...
	public static final Item TETO_PICKAXE_WHATCHACALLITSNAME =
        register(new PickaxeItem(PlushToolMaterial.PLUSH_TOOL_MATERIAL, 1, -2.8f, new FabricItemSettings()), "teto_pickaxe_whatchacallitsname");
